...
public class LineProgressBar extends View {
    ...
    public LineProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LineProgressBar);
        try {
            mMax = a.getInt(R.styleable.LineProgressBar_max, DEFAULT_MAX);
            mProgress = a.getInt(R.styleable.LineProgressBar_progress, DEFAULT_PROGRESS);
            mRadius = (int) a.getDimension(R.styleable.LineProgressBar_progressRadius, DEFAULT_RADIUS);
            mProgressColor = a.getColor(R.styleable.LineProgressBar_lineProgressColor, DEFAULT_PROGRESS_COLOR);
            mProgressDescColor = a.getColor(R.styleable.LineProgressBar_progressDescColor, DEFAULT_PROGRESS_DESC_COLOR);
            mBorderWidth = (int) a.getDimension(R.styleable.LineProgressBar_lineBorderWidth, DEFAULT_BORDER_WIDTH);
            mProgressDesc = a.getString(R.styleable.LineProgressBar_progressDesc);
