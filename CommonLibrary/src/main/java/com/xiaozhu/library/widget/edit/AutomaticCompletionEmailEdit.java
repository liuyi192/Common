...
public class AutomaticCompletionEmailEdit extends AutoCompleteTextView {
    ...
    public AutomaticCompletionEmailEdit(Context context, AttributeSet attrs) {
        super(context, attrs);
        initStyle(context, attrs);
        initWidget(context);
    }

    public AutomaticCompletionEmailEdit(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initStyle(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.AutomaticCompletionEmailEdit, 0, 0);
        DOMAINS = typedArray.getString(R.styleable.AutomaticCompletionEmailEdit_domains);
        DEFAULT_DROP_DOWN_KEY_COLOR = typedArray.getColor(R.styleable.AutomaticCompletionEmailEdit_default_drop_down_key_color, DEFAULT_DROP_DOWN_KEY_COLOR);
        DEFAULT_DROP_DOWN_BG = typedArray.getResourceId(R.styleable.AutomaticCompletionEmailEdit_default_drop_down_bg, 0);
        DEFAULT_DROP_DOWN_DIVIDER = typedArray.getBoolean(R.styleable.AutomaticCompletionEmailEdit_default_drop_down_divider, true);
        typedArray.recycle();
    }
        ...
        setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    AutomaticCompletionEmailEdit ev = (AutomaticCompletionEmailEdit) v;
