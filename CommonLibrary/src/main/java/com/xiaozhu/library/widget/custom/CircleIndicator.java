...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.common_select_indicator;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.common_normal_indicator;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorBackgroundResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable, R.drawable.common_select_indicator);
        mIndicatorUnselectedBackgroundResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable_unselected, R.drawable.common_normal_indicator);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin, R.animator.scale_with_alpha, 0, R.drawable.common_select_indicator, R.drawable.common_select_indicator);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.common_select_indicator : mIndicatorBackgroundResId;
