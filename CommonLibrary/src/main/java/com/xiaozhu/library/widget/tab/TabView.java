package com.xiaozhu.library.widget.tab;
...
import com.xiaozhu.library.utils.DisplayUtil;
...
public class TabView extends RelativeLayout {
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mTabViewHeight = DisplayUtil.dip2px(context, 52);
        mImageViewTextViewMargin = DisplayUtil.dip2px(context, 2);
        mTextViewSize = DisplayUtil.sp2px(context, 14);
        mImageViewWidth = DisplayUtil.dip2px(context, 30);
        mImageViewHeight = DisplayUtil.dip2px(context, 30);
    }
    ...
    public void setTextViewSize(int size) {
        this.mTextViewSize = DisplayUtil.sp2px(getContext(), size);
    }
