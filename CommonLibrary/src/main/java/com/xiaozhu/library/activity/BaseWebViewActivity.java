 ...
 * @备注
 */
public abstract class BaseWebViewActivity extends BaseActivity implements BaseWebView {
    ...
    public void initView() {
        ...
        webSettings.setUserAgentString(webSettings.getUserAgentString() + "_" + getString(R.string.web_user_agent) + "@" + AppUtils.getVersionName(this));
        //网页适配HTML5
